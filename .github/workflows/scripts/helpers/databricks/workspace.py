...
def create_folder_if_not_exists(path: str, host: str, http_header: dict):
...
def get_folder_content(path: str, host: str, http_header: dict) -> list[dict]:
...
def delete_path(path: str, host: str, http_header: dict):
